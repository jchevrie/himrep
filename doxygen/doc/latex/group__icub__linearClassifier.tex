...
This module is responsible for learning and classify feature vectors. Input features are passed, the output are the scores of S\+VM machines. The module provides training methods with real-\/time performances.
...
{\bfseries{R\+E\+C\+O\+G\+N\+I\+ZE}} ~\newline
format\+: \mbox{[}recognize\mbox{]} ~\newline
action\+: starts the recognition process.\hypertarget{group__icub__sparseCoder_lib_sec}{}\subsection{Libraries}\label{group__icub__sparseCoder_lib_sec}
...
\item {\itshape /linear\+Classifier/rpc} receives requests for S\+I\+FT dump or dictionary learning.
