...
{\bfseries{D\+I\+C\+T\+I\+O\+N\+A\+R\+Y\+\_\+\+L\+E\+A\+R\+N\+I\+NG}} format\+: \mbox{[}learn\mbox{]} $<$dictionary\+Size$>$ \char`\"{}use\+P\+C\+A\char`\"{} $<$dim\+P\+C\+A$>$ action\+: starts to learn a dictionary from previously dumped local descriptors. $<$dictionary\+Size$>$ is the number of atoms of the dictionary, \char`\"{}use\+P\+C\+A\char`\"{} performs standard P\+CA analysis on low-\/level descriptors before the encoding and $<$dim\+P\+C\+A$>$ indicates the number of relevant eigenvectors that you want use for the projection.\hypertarget{group__icub__sparseCoder_lib_sec}{}\subsection{Libraries}\label{group__icub__sparseCoder_lib_sec}
